...
- **Hybrid**: Candidate's role directly requires a balance of core technical skills and non-technical business functions (e.g. Product Manager, Technical Business Analyst, Scrum Master, or actual Technical Sales Engineer who does code level integrations/deployments).
  - *ERP/CRM/EXCEL FLAG RULE*: If you classify the resume as **Technical** or **Hybrid** primarily or partly due to skills like ERP (SAP, Oracle, etc.), CRM (Salesforce, HubSpot, etc.), or Advanced Excel / spreadsheets (rather than core coding, programming, or software engineering), you MUST explicitly prefix the "reason" field with the exact text: "[FLAG: Technical/Hybrid due to system/tool skills (ERP, CRM, Excel, etc.) - Not a core software developer/engineer]". Follow this with a detailed explanation of which specific tools/skills led to this classification.
